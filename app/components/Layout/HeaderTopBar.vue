  ...
  <div class="bg-[#212529] text-white py-3 hidden md:block">
    ...
    >
      <div class="flex flex-wrap items-center gap-2 sm:gap-4">
        ...
        <a
          href="mailto:accounts@dynamostitches.com"
          class="flex items-center gap-2 hover:text-primary"
        >
          <Icon name="Mail" size="16" />
      ...
      <div class="flex items-center gap-2 sm:gap-4 mt-2 xl:mt-0">
        <a
          href="https://www.instagram.com/dynamostitches/"
          target="_blank"
          rel="noopener"
        ...
        <a
          href="https://www.facebook.com/share/1F4ALyjdsc/?mibextid=wwXIfr"
          target="_blank"
          rel="noopener"
          class="hover:text-primary"
        >
        ...
        <a
          href="https://www.behance.net/dynamostitches"
          target="_blank"
          rel="noopener"
          class="hover:text-primary"
        >
