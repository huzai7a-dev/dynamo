<template>
  <div class="w-full date-range-select">
    <!-- Label -->
    <label v-if="label" :for="inputId" class="block mb-1 text-sm font-medium text-foreground">
      {{ label }}
    ...
    <div :class="[
      ...
      <!-- Clear Button -->
      <button v-if="fromDate || toDate" @click.stop="clearDates"
    ...
    <div v-if="isOpen"
      ...
      <div class="grid grid-cols-7 gap-1 mb-2">
        <div v-for="day in weekDays" :key="day" class="text-xs font-medium text-muted-foreground text-center py-1">
          {{ day }}
        </div>
      </div>
      ...
      <div class="flex gap-2 mt-4 pt-4 border-t border-gray-200">
        <button @click="setQuickRange('today')" :class="[
        ...
        <button @click="setQuickRange('week')" :class="[
          'flex-1 px-3 py-2 text-xs rounded-lg transition-colors',
          quickRangeType === 'week'
            ? 'bg-primary text-white'
            : 'bg-gray-100 hover:bg-gray-200'
        ...
        <button @click="setQuickRange('month')" :class="[
          'flex-1 px-3 py-2 text-xs rounded-lg transition-colors',
      ...
      <div class="flex gap-2 mt-4">
        <button @click="applySelection" :disabled="!tempFromDate || !tempToDate"
