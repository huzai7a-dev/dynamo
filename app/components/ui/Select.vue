<template>
  <div class="w-full">
    <!-- Label -->
    <div class="relative">
      <label v-if="label" :for="selectId" class="block mb-2 text-sm font-medium text-gray-900">
        {{ label }}
        <span v-if="required" class="text-red-500 text-lg ml-0.5 absolute top-0 right-0">*</span>
      </label>
    </div>
    ...
    <div :class="[
      ...
      <select :id="selectId" v-model="model" :disabled="disabled" :class="[
      ...
      <!-- Chevron Icon -->
      <svg class="pointer-events-none absolute right-3 h-4 w-4 text-gray-600" xmlns="http://www.w3.org/2000/svg"
