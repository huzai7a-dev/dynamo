...
<template>
  <div class="min-h-screen bg-gradient-to-b from-gray-50 to-white">
    <Banner backgroundImage="/images/contact-banner.jpeg" title="Contact Us"
    ...
    <main class="max-w-7xl mx-auto px-4 py-16 sm:px-6 lg:px-8">
      ...
      <div class="text-center mb-16">
        ...
        <p class="text-xl text-gray-600 max-w-3xl mx-auto mt-6">
          Have a Question or a Brilliant Idea? Let's bring it to life together! Reach out to us, and let's create
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-12">
        <!-- Contact Information -->
        <div
          class="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300 border-2 border-black-100 w-full h-full flex flex-col">
          ...
          <div class="space-y-7 flex-1">
            ...
            <div class="flex items-start gap-4">
              ...
              <div>
                ...
                <div class="text-gray-500">{{ CONTACT_NUMBER }}</div>
              </div>
            </div>
        ...
        <div
          ...
          <form class="space-y-6" @submit.prevent="handleSubmit">
            <div v-if="successMessage"
              class="mb-4 text-green-600 bg-green-50 border border-green-200 rounded-lg px-4 py-3 text-center">{{
              successMessage }}</div>
            <div v-if="errorMessage"
              class="mb-4 text-red-600 bg-red-50 border border-red-200 rounded-lg px-4 py-3 text-center">{{ errorMessage
              }}</div>
            <div class="group">
              <label for="firstName"
                class="block text-sm font-medium text-gray-700 mb-1 group-focus-within:text-primary transition-colors duration-200">First
                Name</label>
              <div class="relative">
            ...
            <div class="group">
              <label for="lastName"
                class="block text-sm font-medium text-gray-700 mb-1 group-focus-within:text-primary transition-colors duration-200">Last
                Name</label>
              <div class="relative">
            ...
            <div class="group">
              <label for="contact"
                class="block text-sm font-medium text-gray-700 mb-1 group-focus-within:text-primary transition-colors duration-200">Contact</label>
              <div class="relative">
                <input type="text" id="contact" name="contact" v-model="form.contact"
                  class="block w-full rounded-lg border-gray-200 bg-gray-50 px-4 py-3 text-gray-900 shadow-sm transition-all duration-200 focus:border-primary focus:bg-white focus:ring-2 focus:ring-primary/20 focus:outline-none placeholder:text-gray-400"
            ...
            <div class="group">
              <label for="email"
                class="block text-sm font-medium text-gray-700 mb-1 group-focus-within:text-primary transition-colors duration-200">Email</label>
              <div class="relative">
            ...
            <div class="group">
              <label for="message"
                class="block text-sm font-medium text-gray-700 mb-1 group-focus-within:text-primary transition-colors duration-200">Message</label>
              <div class="relative">
            ...
            <button type="submit" :disabled="isLoading"
              class="w-full bg-teal-gradient text-white px-6 py-3 rounded-lg hover:opacity-90 transition-all duration-200 transform hover:scale-[1.02] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 flex items-center justify-center">
