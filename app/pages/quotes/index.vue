<template>
  <div>
    <QuotesTable @create-order="$router.push('/quotes/create')" :data="data?.data?.quotes ?? []" :pagination="{
      ...
      :loading="pending" :error="!!error" @refresh="refresh" @update:dataSourceType="dataSourceType = $event"
