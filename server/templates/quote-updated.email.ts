...
interface QuoteUpdatedEmailData {
    quoteId: number;
    changes: FieldChange[];
...
export function generateQuoteUpdatedEmail(data: QuoteUpdatedEmailData): string {
    const { changes, user, isAdmin = false, quoteName } = data;
                    ...
                    <tr>
                        <td style="padding: 32px 40px 20px 40px;">
                            ...
                            <p style="
                                ...
                                line-height: 1.75;
                                font-family: 'Inter', Arial, sans-serif;
                            ">Your quote with <strong style="color: #008080;">Dynamo Stitches</strong> has been updated. The fields below reflect the changes that were made.</p>
                            <p style="
                                margin: 0;
                                font-size: 14.5px;
                                color: #374151;
