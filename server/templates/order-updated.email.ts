...
interface OrderUpdatedEmailData {
    orderId: number;
    changes: FieldChange[];
...
export function generateOrderUpdatedEmail(data: OrderUpdatedEmailData): string {
    const { changes, user, subject, isAdmin = false, orderName } = data;
                    ...
                    <tr>
                        ...
                        ">
                            ...
                            ${!isAdmin ? `<h1 style="
                                ...
                                color: #ffffff;
                                line-height: 1.3;
                            ">Your Order Has Been Updated</h1>` : ''}
                            <p style="
                                margin: 8px 0 0 0;
                                font-size: 15px;
                    ...
                    <tr>
                        <td style="padding: 32px 40px 20px 40px;">
                            ...
                            <p style="
                                ...
                                line-height: 1.75;
                                font-family: 'Inter', Arial, sans-serif;
                            ">Your order with <strong style="color: #008080;">Dynamo Stitches</strong> has been updated. The fields below reflect the changes that were made.</p>
                            <p style="
                                margin: 0;
                                font-size: 14.5px;
                                color: #374151;
                                line-height: 1.75;
                                font-family: 'Inter', Arial, sans-serif;
                            ">You may review the full order details anytime within your account under <strong>Order Records</strong>.</p>
                        </td>
                    </tr>
