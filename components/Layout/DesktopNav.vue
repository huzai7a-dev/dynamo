  ...
  <nav class="hidden md:flex items-center space-x-8 relative">
    <template v-for="item in navItems" :key="item.label">
      <div v-if="item.subNav" class="relative group">
        ...
        <div class="absolute left-0 top-full mt-2 w-60 bg-secondary border border-gray-700 rounded-xl shadow-xl hidden group-hover:block z-50 py-2 transition-all duration-200">
